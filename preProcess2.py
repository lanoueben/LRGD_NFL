...
I did this wrong, it's supposed to be x' = (x-(xaverage)) / (xmax-xmin)
...
which is desired
    ...
    columns = ["year","week","team","opponent","first downs", "rush", "rush yards", "rush td",
               ...
               "4 conversions", "4 attempt", "min", "sec", "points"]
    
    
Before running this program, delete the current "masterPost2.xlsx"
and create a new excel file, and name it "masterPost2"
"""
...
def main():
    preM = pd.read_excel("master2.xlsx")
    minL = []
    maxL = []
    avgL = []
    rowNum = preM.shape[0]
    ...
    print(preM)
    preM.to_excel("masterPost2.xlsx",index=False)
